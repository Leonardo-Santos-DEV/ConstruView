    ...
    if (screenError.isAuthError) {
      ...
      return (
        <PageWrapper hasSidebar={navItems.length > 0}>
          ...
          <div
            className="md:ml-56 lg:ml-64 p-4 text-center text-red-500 flex flex-col items-center justify-center flex-grow">
  ...
  if (screenData === null || screenData === undefined) {
    return (
      <PageWrapper hasSidebar={navItems.length > 0}>
        {navItems.length > 0 && <AppNavigation items={navItems}/>}
        <div
          className="md:ml-56 lg:ml-64 p-4 text-center text-slate-300 flex flex-col items-center justify-center flex-grow">
